...
- (void)webViewLoadGif
{
    NSData *gif = [NSData dataWithContentsOfFile: [[NSBundle mainBundle] pathForResource:@"qiutian" ofType:@"gif"]];
    [self.loadGifWebView loadData:gif MIMEType:@"image/gif" textEncodingName:@"UTF-8" baseURL:nil];
...
- (void)loadGif
{
    NSString *path = [[NSBundle mainBundle] pathForResource:@"qiutian" ofType:@"gif"];
    // 设定位置和大小
    CGRect frame = CGRectMake(0.0f, 240.0, 0.0f, 0.0f);
    frame.size = [UIImage imageNamed:@"qiutian.gif"].size;
...
- (void)gifViewLoadGif
{
    GifView *gifView = [[GifView alloc] initWithFrame:CGRectMake(0.0f, 500.0f, self.view.frame.size.width, 225.0f) filePath:[[NSBundle mainBundle] pathForResource:@"qiutian" ofType:@"gif"]];
    gifView.tag = 2015;
